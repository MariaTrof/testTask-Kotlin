...
export declare function updateIn<T, KA extends keyof T, KB extends keyof T[KA], KC extends keyof T[KA][KB], KD extends keyof T[KA][KB][KC]>(path: [KA, KB, KC, KD], newValue: T[KA][KB][KC][KD], object: T): T;
export declare function updateIn<T, KA extends keyof T, KB extends keyof T[KA], KC extends keyof T[KA][KB], KD extends keyof T[KA][KB][KC], KE extends keyof T[KA][KB][KC][KD]>(path: [KA, KB, KC, KD, KE], newValue: T[KA][KB][KC][KD][KE], object: T): T;
...
export declare function removeIn<T, KA extends keyof T, KB extends keyof T[KA], KC extends keyof T[KA][KB], KD extends keyof T[KA][KB][KC]>(path: [KA, KB, KC, KD], object: T): T;
export declare function removeIn<T, KA extends keyof T, KB extends keyof T[KA], KC extends keyof T[KA][KB], KD extends keyof T[KA][KB][KC], KE extends keyof T[KA][KB][KC][KD]>(path: [KA, KB, KC, KD, KE], object: T): T;
